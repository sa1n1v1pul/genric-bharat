          ...
          Row(
            children: [
              ...
              TextButton(
                ...
                child: Text('Call now', style: TextStyle(color: Colors.blue)),
              ),
            ],
          ),
          SizedBox(height: 16),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildStatusItem(
              'Job started', 'Schedule on 17 March, 10:00 AM', false),
          _buildStatusItem('Job Completed', 'Average time 02:00 hours', false,
              isLast: true),
        ],
      ),
    );

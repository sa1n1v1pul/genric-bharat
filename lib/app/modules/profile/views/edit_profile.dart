...
class _EditProfileState extends State<EditProfile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (_profileController.userData.value.isNotEmpty && !initialDataLoaded) {
          _updateFormWithData(_profileController.userData.value);
        }
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: _buildOutlineInputBorder(const Color(0xffE15564)),
                    hintText: "Enter Name",
                    hintStyle: TextStyle(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Checkbox(
                          ...
                          activeColor: isDarkMode ? Colors.white : CustomTheme.loginGradientStart,
                          tristate: false,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isDarkMode ? Colors.white : CustomTheme.loginGradientStart,
